package ru.mirea.galnykin.yandexdriver;
...
import ru.mirea.galnykin.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener, UserLocationObjectListener {
    ...
    private final Point ROUTE_START_LOCATION = new Point(55.660420, 37.474624);
    private final Point ROUTE_END_LOCATION = new Point(56.800084, 59.908718);
    ...
    private void submitRequest() {
        ...
        mapView.getMap().getMapObjects().addPlacemark(ROUTE_END_LOCATION, ImageProvider.fromResource(this, com.yandex.maps.mobile.R.drawable.house_marker_left)).addTapListener(new MapObjectTapListener() {
            @Override
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"г. Ревда",
